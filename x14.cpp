// Intercambiar dos a dos los elementos de una lista
// -------------------------------------------------
...
// Devuelve `false` si se ha encontrado con la marca de fin de entrada
// o `true` si se ha encontrado con un caso de prueba "real".
bool tratar_caso() {
    int n;
    cin >> n;
    if (n == 0) return false;
